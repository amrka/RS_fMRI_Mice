...
%%
n_dims = 15
group_maps='/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/melodic_IC';     % spatial maps 4D NIFTI file, e.g. from group-ICA No extension needed
...
ts_dir='/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/dual_regression/output';                           % dual regression output directory, containing all subjects' timeseries

system('dir=/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/;slices_summary ${dir}melodic_IC 3 /media/amr/Amr_4TB/Work/October_Acquistion/Anat_Template_Enhanced.nii.gz ${dir}melodic_IC.sum -1')
...
ts.DD=[1:15];  % list the good nodes in your group-ICA output (counting starts at 1, not 0)
...
save('/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/dim_15_netmats1.mat', 'netmats1')
save('/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/dim_15_netmats2.mat', 'netmats2')
save('/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/dim_15_netmats3.mat', 'netmats3')
save('/Volumes/Amr_1TB/resting_state/resting_state_gp_ICA+DR_workingdir/melodic_workflow/_dim_15/melodic_group/dim_15_netmats5.mat', 'netmats5')
%%
...
%%
nets_boxplots(ts,netmats2,13,2,16);
