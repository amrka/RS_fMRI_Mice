...
templates = {
             'Anat'     					: '/Volumes/Amr_1TB/resting_state/resting_state_preproc_outputdir/anat_brain/{subject_id}/Anat_Bet_{subject_id}_corrected_ero.nii',

             'Filtered_Smoothed_rs_fMRI'    : '/Volumes/Amr_1TB/resting_state/resting_state_preproc_outputdir/preproc_img/{subject_id}/fwhm-4/rs_fMRI_{subject_id}_mcf_masked_smooth_maths_filt_maths.nii',

             'Melodic_Mix'                  : '/Volumes/Amr_1TB/resting_state/resting_state_preproc_outputdir/melodic/{subject_id}/fwhm-4/Melodic/melodic_mix',
             ...
             'labels'                       : '/Volumes/Amr_1TB/resting_state/resting_state_preproc_outputdir/melodic/{subject_id}/fwhm-5.5.0/_dim_20/Melodic.ica/labels'
...
# Bad_Components_CSV_File = '/home/in/aeed/Work/October_Acquistion/Bad_Components_fwhm_4_dim_20.csv'
...
def get_bad_components(labels):
        ...
        componsents_list = components.split()
...
metaflow.run(plugin='SLURM',plugin_args={'dont_resubmit_completed_jobs': True, 'max_jobs':50, 'sbatch_args': sbatch_params})
...
#proc_1st_level.run(plugin='SLURM',plugin_args={'sbatch_args': sbatch_params,'dont_resubmit_completed_jobs': True, 'max_jobs':50})
