...
# you should have used '/Volumes/Amr_1TB/anat_temp_new/anat_temp_enhanced_3.nii.gz' and '/Volumes/Amr_1TB/anat_temp_new/anat_template_enhanced_mask_2.nii.gz'
# However it does not matter, it was just for disply
# the registeration was done to he correct target, so were the trasnformations
...
melodic_group.inputs.mask = template_mask  # just for display
